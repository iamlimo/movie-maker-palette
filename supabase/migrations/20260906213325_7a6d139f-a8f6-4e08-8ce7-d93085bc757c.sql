DROP VIEW IF EXISTS public.v_admin_rental_records;

CREATE VIEW public.v_admin_rental_records
...
SELECT
  ...
  (i.metadata->>'unlock_push_sent_at')::timestamptz AS unlock_push_sent_at
